/*
 * example.c - QNX Resource Manager for /dev/example
 *
 * Implements a character device resource manager that registers /dev/example
 * in the QNX pathname space. Clients interact via standard POSIX open/read/write.
 *
 * Read returns "hello ", write echoes data to stdout.
 */
